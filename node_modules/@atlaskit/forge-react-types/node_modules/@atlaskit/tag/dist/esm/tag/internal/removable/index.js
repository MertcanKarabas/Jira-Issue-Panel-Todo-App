...
var RemovableTag = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var hoverCloseButtonColors = (_hoverCloseButtonColo = {}, _defineProperty(_hoverCloseButtonColo, cssVar.color.background.hover, styles.removalHoverBackgroundColors), _defineProperty(_hoverCloseButtonColo, cssVar.color.background.active, styles.removalActiveBackgroundColors), _defineProperty(_hoverCloseButtonColo, cssVar.color.text.default, styles.removalTextColors), _defineProperty(_hoverCloseButtonColo, cssVar.color.text.active, styles.removalTextColors), _defineProperty(_hoverCloseButtonColo, cssVar.color.text.link, styles.removalTextColors), _hoverCloseButtonColo);
