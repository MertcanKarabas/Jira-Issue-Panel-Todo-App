...
type IconType = Icon;
export type ButtonProps = Pick<PlatformButtonProps, 'children' | 'autoFocus' | 'isDisabled' | 'isSelected' | 'onBlur' | 'onClick' | 'onFocus' | 'spacing' | 'testId' | 'shouldFitContainer' | 'appearance' | 'type'> & {
    iconBefore?: IconType;
    iconAfter?: IconType;
};
export {};
